                ...
                <div class="hpanel">
                    <div class="panel-body">
                       ...
                       <?php
                            ...
                            $query = "INSERT INTO usuario (nom_us, em_us, pass_us, admin_us, token_us, veri_us) VALUES ('".$user."', '".$email."', '".$pass."', 0, '".$str."', 0);";
                           ...
                           mail($email, "InfoMovie - Verificación de email", "Usted ha solicitado un registro de usuario en la página InfoMovie. Para proceder, haga click en este enlace: $url", "From: InfoMovie <infomoviedam@gmail.com> \r\n");
                            ...
                            echo "<h1 style='color:black;'> Revise su correo para continuar con el registro </h1>";
